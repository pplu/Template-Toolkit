...
Instantiates a plugin object by querying each of the PLUGINS
providers.  The default PLUGINS provider is a Template::Plugins object
which attempts to load plugin modules, according the various
