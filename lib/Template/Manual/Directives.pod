...
From version 2.01 onwards, it is possible to specify multiple template
names within an INCLUDE to have them automatically processed in order.
The template names (quoted or unquoted names only, no unquoted
'$variables') should be delimited by '+'.
