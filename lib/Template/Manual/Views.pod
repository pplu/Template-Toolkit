...
(NOTE: no you can't - I haven't added this facility to the XML::DOM plugin
yet, but expect it Real Soon Now.  The other examples like File, Directory
and Pod all work in 2.01).
