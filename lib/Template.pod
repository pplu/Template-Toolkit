...
#------------------------------------------------------------------------
#
#   $Id: Template.pod,v 1.9 1999/08/16 15:05:19 abw Exp $
#
#========================================================================
...
and contains comprehensive documentation desribing the toolkit, its
...
or point of INCLUDE).  The final option is for the status to be an
exception object.  This is an instance of the Template::Exception
class which can be created by calling the new() construcot.  The first
parameter defines the 'type' of error which may have a corresponding
CATCH handler defined.  The second parameter should be a string
